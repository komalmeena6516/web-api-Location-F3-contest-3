// const showMapbtn = document.getElementById('getLocationBtn');
// const removeBtn = document.getElementById('removeLocationBtn');
// const x = document.getElementById('map');



let btn = document.querySelector('#getLocationBtn');
let x = document.getElementById('map');
let removebtn = document.querySelector('#removeLocationBtn');
let pos = false;
